...
class GameTooltip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tooltipWidth = (160.0 * sc).clamp(120.0, 200.0);
    final tooltipHeight = (180.0 * sc).clamp(140.0, 220.0);
            ...
            child: Column(
              ...
              children: [
                    ...
                    if (data.imagePath != null) ...[
                      Image.asset(
                        ...
                        errorBuilder: (_, __, ___) => data.icon != null
                            ? Text(data.icon!, style: TextStyle(fontSize: Responsive.fontSize(context, 18)))
                ...
                if (data.stats.isNotEmpty) ...[
                  Divider(color: AppColors.borderDefault, height: 10 * sc),
                  ...data.stats.map((stat) => Padding(
                    padding: EdgeInsets.symmetric(vertical: 1 * sc),
                    child: Row(
